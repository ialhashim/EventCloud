...
var Swiper = function (selector, params) {
    ...
    _this.previousLoopIndex = null;
    _this.lastDirection = '';
    _this.virtualIndex = 0;
   ...
   _this.removeStartAddEnd = function( $items ){	
		...
		$.each($items.children(), function( k, v ){
			_this.appendSlide( _this.createSlide( $(v).outerHTML() ) );
		});
   }
   ...
   _this.removeEndAddStart = function( $items ){
    ...
    function swipeToPosition(newPosition, action, toOptions) {
        ...
        if(action=='next') _this.lastDirection = 'next';
        if(action=='prev') _this.lastDirection = 'prev';
    ...
    function slideChangeCallbacks() {
        ...
        _this.lastPosition = _this.getWrapperTranslate('x');
    }
    /*==================================================
        Update Active Slide Index
    ====================================================*/
    _this.updateActiveSlide = function(position) {
        ...
        _this.previousLoopIndex = _this.activeLoopIndex;
